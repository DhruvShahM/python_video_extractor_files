...
# Reduce noise using the first 0.5s as noise sample
def reduce_noise(audio_samples, sample_rate):
    noise_sample = audio_samples[:sample_rate//2]
    return nr.reduce_noise(y=audio_samples, y_noise=noise_sample, sr=sample_rate, prop_decrease=0.9)
