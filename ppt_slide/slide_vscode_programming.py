...
for i in range(slide_count):
    ...
    # Beautify the code just before adding it to the slide
    ...
    # Add formatted code with custom font styles
    p = text_frame.add_paragraph()
    p.text = formatted_code

    # Customize font style for VSCode-like appearance (no italic, no bold)
    p.font.name = "Courier New"  # Monospaced font like VSCode
    p.font.size = Pt(16)  # Adjust font size to your liking
    p.font.bold = False  # Remove bold
    p.font.italic = False  # Remove italic
    p.alignment = PP_ALIGN.LEFT
    p.font.color.rgb = RGBColor(255, 255, 255)  # White font color for visibility
