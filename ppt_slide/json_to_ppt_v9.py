...
class PPTCreatorApp:
    ...
    def add_summary_slide(self, titles,notes=""):
        ...
        self.add_notes_to_slide(slide, notes)      

    def add_table_slide(self, title, table_data,notes=""):
        ...
        for file_path in file_paths:
            ...
            if slides_data:
                ...
                for slide in slides_data:
                    ...
                    notes = slide.get("notes", "")  # Extracting notes
                    slide_titles.append(title)

                if slide_type == "code":
                     self.add_code_slide(title, content, theme["text_color"], theme["bg_color"],notes)
                elif slide_type == "table" and isinstance(content, list):
                     self.add_table_slide(title, content,notes)
                else:
                    self.add_bullet_slide(title, content,notes)
    ...
    def add_text_slide(self, title, content, notes=""):
    ...
    def add_code_slide(self, title, code, text_color, bg_color, notes=""):
    ...
    def add_bullet_slide(self, title, content,notes=""):
        slide_layout = self.prs.slide_layouts[1]  # Title and Content layout
        slide = self.prs.slides.add_slide(slide_layout)
        title_placeholder = slide.shapes.title
        content_placeholder = slide.shapes.placeholders[1]
    ...
    def add_notes_to_slide(self, slide, notes_text):
