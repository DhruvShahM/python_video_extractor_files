...
class PPTCreatorApp:
    ...
    def add_slide(self):
        ...
        self.slides.append((title, content, slide_type, len(self.slides)))
    ...
    def save_current_slide(self):
        if 0 <= self.current_slide < len(self.slides):
            ...
            content = self.content_text.get("1.0", tk.END).strip()
            slide_type = self.slide_type.get()
            self.slides[self.current_slide] = (title, content, slide_type, self.current_slide)
    ...
    def next_slide(self):
        ...
        if self.current_slide < len(self.slides) - 1:
            ...
            self.status_label.config(text="🚫 कोई अगली स्लाइड नहीं!", fg="red")
    ...
    def prev_slide(self):
        ...
        if self.current_slide > 0:
            ...
            self.status_label.config(text="🚫 कोई पिछली स्लाइड नहीं!", fg="red")

    def load_slide(self):
        if 0 <= self.current_slide < len(self.slides):
            title, content, slide_type, _ = self.slides[self.current_slide]
            self.title_entry.delete(0, tk.END)
