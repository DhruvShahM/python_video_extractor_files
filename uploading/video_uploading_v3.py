...
TOKEN_FILE = "C:/Users/dhruv/Videos/Video_Extractor_Python_Files/python_video_extractor_files/uploading/token.pickle"
...
def get_authenticated_service():
    """Authenticate and return a YouTube API service instance with token persistence."""
    credentials = None
    ...
    # If no credentials exist or they are invalid, perform authentication
